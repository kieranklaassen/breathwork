    ...
    <>
      ...
      >
        ...
        <div className={styles.content}>
          ...
          <div ref={mainCardRef} className={styles.mainCard}>
            ...
            <div className={styles.phaseLabel}>
              <span
                ...
                style={{
                  color: isPlaying ? phaseColor : 'rgba(232, 224, 228, 0.6)',
                }}
              >
                {phaseLabel}
                {timer.phase === 'inhale' && (
            ...
            <div className={styles.phaseControls}>
              {PHASE_FIELDS.map(({ key, label, color }) => {
                ...
                return (
                  ...
                  >
                    <div className={styles.phaseControlLabel} style={{ color }}>
                      {label}
                    </div>
          ...
          {/* Empty State */}
          {cycleCount <= 1 && !isPlaying && (
            <div className={styles.emptyState}>
              <div className={styles.emptyIcon}>🌸</div>
              <h3 className={styles.emptyTitle}>Begin your practice</h3>
